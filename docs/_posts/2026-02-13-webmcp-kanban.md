---
layout: posts
title: "Building a WebMCP Kanban Board: Browser-Native AI Integration With Zero Backend"
description: "A complete implementation of a kanban board with 8 AI-callable tools, connected to Claude through Chrome DevTools MCP. No backend. No database. No API server."
date: 2026-02-13
categories: [AI, MCP, Web Development, React, Side Projects]
---
